<%@ Page Title="Inscrire une connexion externe" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="test.Account.RegisterExternalLogin" Async="true" %>
